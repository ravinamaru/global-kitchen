            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                        <img src="image\blog-3.jpg" class="img-fluid rounded" alt="">
                    </div>
                    <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
                        <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">About Us</small>
                        <h1 class="display-5 mb-4">Trusted By 200 + satisfied clients</h1>
                        <p class="mb-4">Global Kitchen is conveniently located in the heart of the city at Ambavadi area with secluded enough location to enjoy a meal
                            away from the noise of the city's hustle bustle. We offer a contemporary interpretation of classic indian and multi-cuisine dishes in a modern
                            exclusive setting with impeccable service. We will try to give satisfaction our all clients who connected us. We have been rated as top of the 
                            restaurants of the city and have been featured as a unique dining experience. Be it a dinner for two or a large gethering for celebrations and 
                            events, Global Kitchen is certain to please.
                        </p>
                        <div class="row g-4 text-dark mb-5">
                            ...
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>Supported team members
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>All food is fresh and testy
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>Take order for any events
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>Great experience form here
                            </div>
                        </div>
                    </div>
                </div>
