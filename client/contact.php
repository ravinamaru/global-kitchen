                        ...
                        <div class="col-md-6 col-lg-5">
                            <div>
                                <div class="d-inline-flex w-100 border border-primary p-4 rounded mb-4">
                                    ...
                                    <div class="">
                                        <h4>Address</h4>
                                        <p>Shreekunj Mandapam, Beside Golden Tulip Banglows, Ahmedabad-380015.</p>
                                    </div>
                                </div>
                                <div class="d-inline-flex w-100 border border-primary p-4 rounded mb-4">
                                    ...
                                    <div class="">
                                        <h4>Mail Us</h4>
                                        <p class="mb-2">global@gmail.com</p>
                                        <p class="mb-0">gkitchen@gmail.com</p>
                                    </div>
                                </div>
                                <div class="d-inline-flex w-100 border border-primary p-4 rounded">
                                    ...
                                    <div class="">
                                        <h4>Telephone</h4>
                                        <p class="mb-2">098240 90111</p>
                                        <p class="mb-0">095106 86262</p>
                                    </div>
                                </div>
                            </div>
                        </div>
